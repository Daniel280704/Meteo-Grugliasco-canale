...
def interpella_groq(dati_testuali, oggi_str, giorni_str):
    ...
    prompt = f"""
    Sei un meteorologo professionista. Il tuo compito è scrivere un bollettino discorsivo, fluido ed elegante per Grugliasco (TO) a MEDIO TERMINE, partendo dalla sintesi oraria fornita.
