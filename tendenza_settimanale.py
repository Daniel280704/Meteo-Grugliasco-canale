...
def interpella_gemini(dati_tendenza):
    ...
    prompt = f"""
    Sei un meteorologo professionista. Scrivi una PANORAMICA SINTETICA (tendenza meteo a medio termine) per Grugliasco (TO) per i tre giorni successivi indicati in tabella.
